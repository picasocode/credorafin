        ...
        >
          ...
          <div className="p-6 flex flex-col flex-1">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              >
                <DynamicIcon name={post.categoryIcon} className="w-3 h-3" />
                {post.category}
              </span>
        ...
        <div className="p-6 md:p-8 flex-1 flex flex-col justify-center">
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <span
              ...
              style={{ color: post.color, backgroundColor: `${post.color}10` }}
            >
              <DynamicIcon name={post.categoryIcon} className="w-3.5 h-3.5" />
              {post.category}
            </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SmoothReveal className="mb-8">
            <h2 className="text-2xl font-semibold text-[#1C1D62] flex items-center gap-2">
              ...
              {loading && (
                <span className="inline-flex items-center gap-1.5 ml-2 text-[11px] font-normal text-[#304AC0]/70">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#304AC0] animate-pulse" />
                  Loading…
                </span>
              )}
            </h2>
