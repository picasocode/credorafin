  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F7F9FC]">
      <div className="flex flex-col items-center gap-3">
        <div className="w-10 h-10 rounded-full border-2 border-[#304AC0]/20 border-t-[#304AC0] animate-spin" />
        <p className="text-xs font-medium text-[#718096]">Loading article…</p>
      </div>
    </div>
  );
}
