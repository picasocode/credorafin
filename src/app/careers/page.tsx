...
const openPositions = [
  {
    ...
    skills: ["Financial Statement Analysis", "CIBIL / Credit Bureau", "MSME Lending", "Excel & MIS Reporting"],
  },
  {
    id: 2,
    ...
    skills: ["B2B Sales", "Loan Origination", "Client Relationship Management", "Negotiation"],
  },
  {
    id: 3,
    ...
    skills: ["Loan Processing", "Documentation", "Banking Operations", "Attention to Detail"],
  },
  {
    id: 4,
    ...
    skills: ["Lead Generation", "Partner Onboarding", "CRM Tools", "Communication"],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    skills: ["Google Ads", "SEO / SEM", "Social Media Marketing", "Analytics & Reporting"],
  },
];
...
const hiringSteps = [
  ...
  { title: "Screen", description: "Our HR team reviews your profile and reaches out within 3 business days.", icon: Search, accent: "#13277E" },
...
/* ────────────────────────────────────────────
   SEARCH ICON (inline to avoid import issues)
   ──────────────────────────────────────────── */
                  ...
                  <div className="absolute top-16 -right-3 w-6 z-20 pointer-events-none hidden md:block">
                    <svg viewBox="0 0 24 40" className="w-full h-10" fill="none" aria-hidden="true">
                      ...
                      <motion.circle
                        ...
                        style={{ offsetPath: "path('M0 20 C12 4, 12 36, 24 20')" }}
                      />
                    </svg>
                  </div>
                )}
