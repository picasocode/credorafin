...
const product = products.find((p) => p.slug === "supply-chain-finance")!;
const otherProducts = products.filter((p) => p.slug !== "supply-chain-finance");
const accent = product.color;
const heroImage = "/images/products/scf-hero.png";

const eligibilityIcons = [Building2, Banknote, Shield, Clock];
const statIcons = [Percent, Clock, TrendingUp, Banknote];
    ...
    <div>
        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Key requirements to qualify for our supply chain finance solutions.</p>
            </SectionReveal>
      ...
      {product.processSteps && product.processSteps.length > 0 && (
        <ProcessInfographic
          ...
          accentColor={accent}
          subtitle="From invoice submission to settlement — our streamlined process gets you funded fast."
        />
      )}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <SlideReveal direction="left">
                ...
                <p className="text-[#718096] mb-8 max-w-lg">Why businesses trust Credora for their supply chain finance needs.</p>
              ...
              <SlideReveal direction="right" delay={0.2}>
                <div className="relative flex items-center justify-center">
                  <div className="w-80 h-80 sm:w-96 sm:h-96 lg:w-[32rem] lg:h-[32rem]">
                    <img src="/images/sections/supply-chain-finance.png" alt="Modern warehouse with supply chain logistics and vendor payment operations" className="rounded-2xl shadow-xl w-full h-full object-cover" />
                  </div>
                </div>
              </SlideReveal>
            </div>
        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Common questions about supply chain finance and how it works.</p>
            </SectionReveal>
            <SectionReveal delay={0.1}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionReveal>
            <div className="rounded-2xl border-2 p-8 sm:p-10 md:p-14 text-center relative overflow-hidden" style={{ borderColor: `${accent}30` }}>
              ...
              <p className="text-[#718096] mb-8 max-w-lg mx-auto">Get our detailed brochure with complete product information, cost structures, and case studies.</p>
              {success ? (
