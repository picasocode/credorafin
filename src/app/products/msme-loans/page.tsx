...
const product = products.find((p) => p.slug === "msme-loans")!;
const otherProducts = products.filter((p) => p.slug !== "msme-loans");
const accent = product.color;
const heroImage = "/images/products/msme-hero.png";

const eligibilityIcons = [Users, TrendingUp, Shield, Sprout];
const statIcons = [Banknote, Clock, Percent, Building2];
              ...
              <SlideReveal direction="right" delay={0.2}>
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <motion.div style={{ y: parallaxY }}>
                    <Image
                      src={heroImage}
                      alt="MSME business growth and financing"
                      width={600}
                      height={400}
                ...
                <FloatingElement className="absolute -top-6 -right-4 hidden lg:block" amplitude={8} duration={4}>
                  <div className="w-24 h-24 opacity-80">
                    <AnimatedIllustration theme="business" size={96} color={accent} />
                  </div>
                </FloatingElement>
              </SlideReveal>
            </div>
        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Understand the key requirements to qualify for our MSME loan products.</p>
            </SectionReveal>
      ...
      <section id="products-section" className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionReveal>
            ...
            <p className="text-[#718096] mb-10 ml-12 max-w-2xl">A comprehensive range of MSME loan products tailored to different business needs and stages.</p>
          </SectionReveal>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-[#1C1D62]">How It Works</h2>
              </div>
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Our streamlined process ensures you get funded quickly and efficiently.</p>
            </SectionReveal>
            <div className="relative max-w-3xl mx-auto">
              {/* Vertical connecting line */}
              <div className="absolute left-6 top-0 bottom-0 w-0.5" style={{ backgroundColor: `${accent}20` }} />
                ...
                {product.processSteps.map((step, idx) => (
                  ...
                  >
                    <div className="relative z-10 flex-shrink-0">
                      ...
                      >
                        <PulseGlow color={accent}>
                          <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg" style={{ backgroundColor: accent }}>
                            {idx + 1}
                          </div>
                        </PulseGlow>
                      </motion.div>
                    ...
                    <motion.div
                      className="bg-white rounded-xl border border-[#E8ECF0] p-5 shadow-sm flex-1"
                      whileHover={{ y: -3, boxShadow: "0 10px 20px rgba(0,0,0,0.08)" }}
                      transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    >
                      <h3 className="text-base font-semibold text-[#1C1D62] mb-1">{step.title}</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <SlideReveal direction="left">
                ...
                <p className="text-[#718096] mb-8 max-w-lg">Why businesses choose Credora for their MSME funding needs.</p>
        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Common questions about our MSME loan products and process.</p>
            </SectionReveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionReveal>
            <div className="rounded-2xl border-2 p-8 sm:p-10 md:p-14 text-center relative overflow-hidden" style={{ borderColor: `${accent}30` }}>
              ...
              <p className="text-[#718096] mb-8 max-w-lg mx-auto">Get our detailed brochure with complete product information, eligibility criteria, interest rate benchmarks, and application checklist.</p>
              {success ? (
                ...
                <form onSubmit={handleBrochureSubmit} className="flex flex-col sm:flex-row items-center gap-3 max-w-md mx-auto">
                  <Input
                    ...
                    className="flex-1 h-12 bg-white border-[#E8ECF0]"
                    disabled={loading}
                    required
                  />
                  <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                    <Button
                      type="submit"
                      disabled={loading}
                      className="h-12 px-7 text-white font-semibold text-sm uppercase tracking-wider rounded-md whitespace-nowrap"
                  ...
                  >
                    <Link href={`/products/${op.slug}`} className="group flex flex-col h-full min-h-[180px] bg-white rounded-xl border border-[#E8ECF0] p-5 shadow-sm transition-all duration-300">
                      <div className="flex items-center gap-3 mb-3">
                        {OpIcon && (
                          <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: `${op.color}10` }}>
                            <OpIcon className="w-5 h-5" style={{ color: op.color }} />
                          </div>
                        )}
                        <span className="text-xs font-bold uppercase tracking-widest" style={{ color: op.color }}>
                          {op.products.length} Product{op.products.length !== 1 ? "s" : ""}
                        </span>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <SectionReveal>
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">Ready to Fuel Your Business Growth?</h2>
              <p className="text-white/70 mb-0 text-base sm:text-lg">Our advisors can help you find the right MSME funding solution tailored to your business needs. Get started with a free consultation today.</p>
            </SectionReveal>
