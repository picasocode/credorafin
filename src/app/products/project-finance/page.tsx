...
const product = products.find((p) => p.slug === "project-finance")!;
const otherProducts = products.filter((p) => p.slug !== "project-finance");
const accent = product.color;
const heroImage = "/images/products/project-hero.png";

const eligibilityIcons = [Landmark, Users, BarChart3, FileCheck];
const statIcons = [Banknote, Clock, Clock, Clock];
    ...
    <div>
              ...
              <SlideReveal direction="right" delay={0.2}>
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <motion.div style={{ y: parallaxY }}>
                    <Image
                      src={heroImage}
                      alt="Construction and project finance for large-scale developments"
                      width={600}
                      height={400}
        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Key requirements for project finance approval and funding.</p>
            </SectionReveal>
      ...
      <section id="products-section" className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionReveal>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${accent}12` }}>
                <HardHat className="w-5 h-5" style={{ color: accent }} />
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1C1D62]">Product Offerings</h2>
            </div>
            <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Structured funding solutions for real estate development, construction projects, and inventory management.</p>
          </SectionReveal>
      ...
      {product.processSteps && product.processSteps.length > 0 && (
        <ProcessInfographic
          ...
          accentColor={accent}
          subtitle="From project assessment to milestone-based disbursal — our process is designed for large-scale developments."
        />
      )}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <SlideReveal direction="left">
                ...
                <p className="text-[#718096] mb-8 max-w-lg">Why developers and businesses choose Credora for project finance.</p>
              ...
              <SlideReveal direction="right" delay={0.2}>
                <div className="relative flex items-center justify-center">
                  <div className="w-80 h-80 sm:w-96 sm:h-96 lg:w-[32rem] lg:h-[32rem]">
                    <img src="/images/sections/project-finance.png" alt="Large industrial construction site with tower cranes for project finance infrastructure development" className="rounded-2xl shadow-xl w-full h-full object-cover" />
                  </div>
                </div>
              </SlideReveal>
            </div>
        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">Common questions about project finance, moratorium periods, and structuring.</p>
            </SectionReveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionReveal>
            <div className="rounded-2xl border-2 p-8 sm:p-10 md:p-14 text-center relative overflow-hidden" style={{ borderColor: `${accent}30` }}>
              ...
              <p className="text-[#718096] mb-8 max-w-lg mx-auto">Get our detailed brochure with project finance structures, case studies, and development timelines.</p>
              {success ? (
      ...
      <section className="py-16 md:py-20 relative overflow-hidden" style={{ backgroundColor: "#1C1D62" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <SectionReveal>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4">Fund Your Next Big Project</h2>
              <p className="text-white/70 mb-0 text-base sm:text-lg">From land acquisition to project completion, we structure funding that aligns with your development timeline and cash flows.</p>
            </SectionReveal>
