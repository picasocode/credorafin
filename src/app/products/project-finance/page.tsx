        ...
        <section className="py-16 md:py-20 bg-[#F7F9FC]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionReveal>
              ...
              <p className="text-[#718096] mb-10 ml-12 max-w-2xl">From project assessment to milestone-based disbursal — our process is designed for large-scale developments.</p>
            </SectionReveal>
