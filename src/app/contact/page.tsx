          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <SectionReveal direction="left" delay={0.15}>
                <motion.div
                  whileHover={{ y: -3, boxShadow: "0 12px 24px rgba(48,74,192,0.10)" }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                >
                  <div className="relative rounded-2xl overflow-hidden border border-[#E8ECF0] h-48">
                    <Image
                      src="/images/pages/office-india.png"
                      alt="Credora office in Chennai"
                      fill
                      sizes="100vw"
                      className="object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1C1D62]/80 to-transparent" />
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="flex items-center gap-2 text-white">
                        <Building2 className="w-4 h-4" />
                        <span className="text-sm font-medium">Chennai, Tamil Nadu</span>
                      </div>
                      <p className="text-white/70 text-xs mt-1">Anna Nagar West Extension</p>
                    </div>
                  </div>
                </motion.div>
              </SectionReveal>
                          ...
                          >
                            ...
                            <div className="grid sm:grid-cols-2 gap-5">
                              ...
                              <div>
                                ...
                                <motion.div
                                  animate={{
                                    boxShadow: focusedField === "businessType"
                                      ? "0 0 0 3px rgba(48,74,192,0.1)"
                                      : "0 0 0 0px rgba(48,74,192,0)"
                                  }}
                                  transition={{ duration: 0.2 }}
