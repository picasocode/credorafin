...
export default function PreUnderwritingPage() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* ─── 5. 5-Step Preparation Checklist — Infographic ─── */}
      <ProcessInfographic
        steps={preparationChecklist.map((item) => ({
          icon: item.icon,
          label: item.title,
          desc: item.desc,
        }))}
        color={service.color}
        heading="5-Step Preparation Checklist"
        subtext="Every successful application starts with thorough preparation. Here's our structured approach to getting you application-ready."
        compact
      />
