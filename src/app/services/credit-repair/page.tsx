...
export default function CreditRepairPage() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* ─── 4. Process Steps — Visual Timeline ─── */}
      <section className="py-16 md:py-24 bg-[#F0F4FF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <FadeIn>
            <div className="text-center mb-14">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1C1D62] mb-3">Our Process</h2>
              <p className="text-[#718096] max-w-2xl mx-auto">A systematic, transparent approach to improving your credit profile — from initial analysis to confirmed score updates.</p>
            </div>
          </FadeIn>
              ...
              return (
                <FadeIn key={idx} delay={idx * 0.08}>
                  <div className="flex gap-5 mb-8 last:mb-0">
                    ...
                    <motion.div className="bg-white rounded-xl border border-[#E8ECF0] p-5 sm:p-6 shadow-sm flex-1 group transition-all duration-300" whileHover={{ y: -3, boxShadow: "0 8px 30px rgba(48,74,192,0.1)", borderColor: service.color }}>
