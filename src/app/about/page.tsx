...
function StatCounter({ value, suffix, label }: { value: number; suffix: string; label: string }) {
  ...
  return (
    <motion.div
      ref={ref}
      className="flex items-center gap-2 px-5 sm:px-8 first:pl-0"
      ...
      <section className="bg-[#F0F4FF] py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
          <SectionReveal>
            ...
            <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#304AC0] rounded-r-full hidden sm:block" style={{ left: "max(0px, calc((100vw - 80rem) / 2))" }} />
            ...
            >
              We Prepare You for Funding.{" "}
              <span className="relative inline-block">
                <span className="relative z-10 text-[#304AC0]">Not Just Arrange It.</span>
                <motion.span
                  className="absolute bottom-1 left-0 right-0 h-2 bg-[#87B73C]/20 rounded"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
            ...
            <p className="mt-5 text-[#2D3748] leading-relaxed max-w-2xl text-base sm:text-lg">
              ...
              financial advisory partner, preparing your business for
          ...
          <SectionReveal delay={0.2}>
            <div className="mt-10 flex flex-wrap items-center gap-4 sm:gap-0 sm:divide-x sm:divide-[#304AC0]/20">
              {stats.map((stat, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SmoothReveal>
            ...
            <p className="text-[#2D3748] leading-relaxed max-w-3xl mt-4 text-base sm:text-lg pl-6 sm:pl-8 border-l-4 border-transparent">
              We assess your financials, CIBIL profile, and overall eligibility
