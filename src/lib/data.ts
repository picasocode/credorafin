...
export const products: ProductData[] = [
  {
    ...
    products: [
      ...
      { name: "Working Capital — CGTMSE Secured and Unsecured", desc: "Working capital under CGTMSE, offering both collateral-free and secured funding for MSMEs. Government-backed guarantee scheme for faster processing.", features: ["CGTMSE coverage up to ₹10 Crore", "Collateral-free option available", "Fund-based and non-fund based facilities", "Quick processing with guarantee cover"] },
      { name: "Machinery Finance", desc: "Loans to purchase new or used machinery to enhance production capacity. Structured repayment aligned with equipment lifespan.", features: ["New and used machinery", "Up to 90% financing", "Tenure aligned with machinery life"] },
    ...
    eligibility: [
      ...
      { label: "Credit Profile", desc: "CIBIL score of 675+ with manageable existing obligations. Lower scores may qualify with additional security." },
    ...
    faqs: [
      { q: "What is the typical loan amount for MSME loans?", a: "MSME loans range from ₹5 Lakhs to ₹5 Crores depending on the product and your business profile. CGTMSE-backed loans can go up to ₹10 Crores without collateral." },
