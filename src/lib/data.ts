export interface ProductData {
  ...
  icon: string;
  color: string;
  products: { name: string; desc: string; features?: string[]; subProducts?: { name: string; desc: string; features?: string[] }[] }[];
  benefits: string[];
...
export const products: ProductData[] = [
  {
    ...
    fullDesc: "MSME loans provide essential capital for micro, small, and medium enterprises in manufacturing, trading, and services. Whether you need working capital, equipment purchase, or expansion, we structure un-secured and secured options under schemes like CGTMSE. With access to 70+ lenders, we match your profile to the right institution — ensuring competitive rates and faster approvals.",
    icon: "Building2",
    color: "#304AC0",
    products: [
      { name: "Unsecured Business Loans — Term Loans / Flexi OD", desc: "Collateral-free funding for expansion, working capital, and day-to-day operations. Flexible repayment with term loan or overdraft facility.", features: ["No collateral required", "Loan amount up to ₹5Cr", "Tenure 1–5 years", "Hybrid/Flexi OD option available"] },
      { name: "Loan Against Property and LRD", desc: "Raise funds against immovable property or rental income (Lease Rental Discounting). Ideal for larger funding needs with property as security.", features: ["Residential/commercial/industrial/vacant/institutional property", "Up to 100% of property value", "LRD for rental income monetization", "Tenure up to 15 years"] },
      { name: "Working Capital — CGTMSE Secured and Unsecured", desc: "Working capital under CGTMSE, offering both collateral-free and secured funding for MSMEs. Government-backed guarantee scheme for faster processing.", features: ["CGTMSE coverage up to ₹5 Crore", "Collateral-free option available", "Fund-based and non-fund based facilities", "Quick processing with guarantee cover"] },
      { name: "Machinery Finance", desc: "Loans to purchase new or used machinery to enhance production capacity. Structured repayment aligned with equipment lifespan.", features: ["New and used machinery", "Up to 90% financing", "Re-finance on existing machinery", "Tenure aligned with machinery life"] },
      { name: "Solar Finance", desc: "Funding support for solar projects, renewable energy and EPC contractors. Capital for installation, equipment, and grid connectivity.", features: ["Capex and Opex", "Capital subsidy assistance", "Long tenure up to 15 years", "Green energy initiatives"] },
      { name: "Commercial Vehicle Finance", desc: "Funding solutions for purchased vehicles to support business operations. Covers LMV, HMV and construction equipment.", features: ["New and used vehicles", "Up to 90% funding on-road price", "Re-finance on existing vehicles", "Flexible EMI options"] },
    ...
    eligibility: [
      ...
      { label: "Annual Turnover", desc: "Meeting MSME classification threshold norms for micro (up to ₹5 Cr), small (up to ₹50 Cr), or medium (up to ₹250 Cr) enterprises." },
      { label: "Credit Profile", desc: "Credit score of 675+ with manageable existing obligations. Lower scores may qualify with additional security." },
    ...
    processSteps: [
      ...
      { title: "Product Matching", desc: "Identify the best loan product and suitable lenders for your profile" },
      { title: "Application Structuring", desc: "Prepare and structure your application for maximum approval" },
      { title: "Lender Submission", desc: "Submit to suitable lenders based on the assessment with minimal enquiry" },
      ...
      { title: "End-to-end Support", desc: "End-to-end support up to 1 year" },
    ],
    faqs: [
      { q: "What is the typical loan amount for MSME loans?", a: "MSME loans range from ₹5 Lakhs to ₹5 Crores depending on the product and your business profile. CGTMSE-backed loans can go up to ₹5 Crores without collateral." },
      { q: "How long does the approval process take?", a: "Unsecured business loans typically take 3–7 days. Secured loans like Loan Against Property may take 15–30 days. We help expedite by ensuring your application is complete and properly structured." },
    ...
    stats: [
      { label: "Loan Amount Range", value: "5", suffix: "L to 5Cr" },
      { label: "Processing Time", value: "3", suffix: "–14 days" },
      { label: "Approval Rate", value: "95", suffix: "%" },
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Inventory Finance", desc: "Funding against stock and purchase to maintain smooth operations. Monetize warehouse inventory without selling assets.", features: ["Unlock Inventory Value", "Strengthen Working Capital", "Maintain Optimal Stock Levels", "Scale with Flexible Funding"] },
      { name: "Working Capital Demand Loan", desc: "Short-term loans to meet immediate working capital requirements and quick disbursal.", features: ["Quick processing", "Short-term tenure", "Flexible utilization", "Top-up facility available"] },
    ],
    benefits: [
      "Faster access to liquidity without a heavy Credit Report impact",
    ...
    processSteps: [
      ...
      { title: "Verification & Approval", desc: "Review invoices, purchase orders, buyer/supplier details, and transaction documents for eligibility and approval" },
      { title: "Funding Arrangement", desc: "Funding partners provide up to 100% of eligible invoice or transaction value based on the approved financing structure and credit terms" },
      { title: "Disbursal", desc: "Funds are released directly to the supplier, vendor, or business as per the financing arrangement" },
      { title: "Settlement & Continuity", desc: "The financed amount is settled as per agreed payment terms, ensuring uninterrupted cash flow and ongoing business operations" },
    ],
    faqs: [
      ...
      { q: "Does invoice discounting affect my balance sheet?", a: "It depends on the financing structure. Invoice discounting may be treated as either an on-balance-sheet or off-balance-sheet transaction based on the product type, lender requirements, and accounting treatment. We help you evaluate the most suitable option for your business." },
      ...
      { q: "What types of invoices are eligible?", a: "Invoices to External rated corporates, government departments, and approved buyers. Both sales invoices (receivables) and purchase invoices (payables) can be financed." },
      { q: "What is the cost of supply chain finance?", a: "Costs vary based on buyer rating, invoice tenure, and market conditions. Typically 0.80% to 1.2% per month. We ensure competitive pricing by presenting to multiple funders." },
    ],
    stats: [
      { label: "Advance Rate", value: "95", suffix: "%" },
      { label: "Disbursal Speed", value: "12", suffix: "–24 hrs" },
      { label: "Onboarding TAT", value: "7", suffix: "–15 days" },
      { label: "Typical Amount", value: "₹50", suffix: "L – ₹50Cr" },
    ],
  ...
  },
  {
    ...
    eligibility: [
      ...
      { label: "Trade Volume", desc: "Minimum 3 trade consignments. Higher limits for established international traders." },
      { label: "Documentation", desc: "Proper purchase orders, letters of credit, shipping bills, and shipping documents." },
      { label: "Compliance", desc: "Compliance with proper repatriation of export proceeds and import payments." },
    ],
    processSteps: [
      { title: "Trade Assessment", desc: "Understand your trade cycle, buyer/supplier relationships, and working cycle" },
      ...
      { title: "Lender Matching", desc: "Submit to trade finance specialists who understand your industry and trade corridors." },
    ...
    faqs: [
      ...
      { q: "Can startups with new export orders qualify?", a: "Yes, businesses with a previous history of minimum 3 export orders or LC from creditworthy buyers can qualify. The buyer's creditworthiness is a key factor." },
      { q: "What documents are needed for cross-border finance?", a: "Key documents include: IEC registration, purchase orders/LC, commercial invoice, packing list, shipping bill, bill of loading/airway bill, and bank realization certificate (for post-shipment)." },
      ...
      { q: "What is the typical funding amount for cross-border finance?", a: "Funding can range from 100K USD to 2M USD depending on your trade volume, buyer profile, and the type of finance required. Each transaction is structured based on the specific trade cycle." },
    ],
    stats: [
      { label: "Funding Range", value: "100", suffix: "k USD to 2M USD" },
      { label: "Processing Time", value: "12", suffix: "–24 hr" },
      { label: "Advance Rate", value: "90", suffix: "%" },
      { label: "Trade Corridors", value: "Across Global", suffix: "" },
    ],
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Inventory Funding", desc: "Capital against unsold project inventory for builders and developers. Unlock cash from completed but unsold units.", features: ["Against unsold units", "Up to 60% of inventory value", "Inventory to sales cycle", "Flexible repayment from sales proceeds"] },
    ],
    benefits: [
    ...
    eligibility: [
      { label: "Project Stage", desc: "Projects at planning, under-construction, or near-completion stages. RERA/DTCP registration where applicable." },
      ...
      { label: "Documentation", desc: "Complete project documentation including land titles, approvals, RERA/DTCP registration, and financial projections." },
    ],
    processSteps: [
      ...
      { title: "Lender Matching", desc: "Submit to lenders specializing in project and real estate finance" },
    ...
    faqs: [
      ...
      { q: "What is moratorium period in project finance?", a: "A moratorium period allows you to defer principal repayment during the construction phase. Interest may be serviced or capitalized depending on the structure. Typically available for 12–24 months." },
      ...
      { q: "How is project finance different from a regular business loan?", a: "Project finance is structured around the project's cash flows and milestones, not just your business financials. Repayment is typically linked to project revenue, with projections-based disbursal and potential moratorium periods." },
      { q: "What security is required for project finance?", a: "Typically, the project land and assets are primary security. Additional collateral may be required based on lender assessment and project risk profile." },
    ],
    stats: [
      { label: "Funding Range", value: "₹1", suffix: "Cr – ₹100Cr" },
      { label: "Processing Time", value: "15", suffix: "–45 days" },
      { label: "Moratorium", value: "Up to 12", suffix: " months" },
      { label: "Tenure", value: "Up to 10", suffix: " years" },
    ],
  ...
  },
  {
    ...
    color: "#87B73C",
    products: [
      { name: "Third Party Security Funding", desc: "Loans backed by collateral provided by a third party on behalf of the borrower. Ideal when the borrower doesn't have sufficient assets but a guarantor does.", features: ["Third-party property as collateral", "FD and Collateral backing", "Family/guarantor support", "Flexible structuring"] },
      ...
      { name: "Inventory Funding — Sector Specific", desc: "Sector-specific funding against stock for niche industries. Customized inventory finance for specialized business needs.", features: ["Industry-specific structures", "Commodity & specialty stock", "Revolving Credit facility", "Market-linked pricing"] },
      ...
      { name: "ARC and Stressed Asset Solutions", desc: "Specialized support for resolving stressed or non-performing financial assets through ARC processes.", features: ["ARC structuring", "Stressed asset resolution", "Revaluation Support", "Restructuring advisory"] },
      { name: "NCLT Purchase", desc: "Acquisition and resolution of assets under insolvency proceedings. Navigate the NCLT process with expert guidance.", features: ["NCLT process navigation", "Resolution plan structuring", "Bid preparation support", "Regulatory Preparing"] },
    ...
    stats: [
      ...
      { label: "Avg Resolution", value: "1", suffix: " week to 3 months" },
    ],
