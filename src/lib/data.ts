...
export const services: ServiceData[] = [
  {
    ...
    whatWeDo: [
      ...
      "Provide ongoing credit health monitoring and advisory",
    ],
    benefits: [
    ...
    processSteps: [
      { title: "Credit Report Analysis", desc: "Obtain and thoroughly analyze your CIBIL, Experian, and Equifax reports for errors and negative entries" },
    ...
    stats: [
      ...
      { label: "Avg Resolution Time", value: "45", suffix: " days" },
      { label: "Clients Helped", value: "500", suffix: "+" },
    ],
  },
  {
    ...
    benefits: [
      ...
      "Significantly higher approval chances (from ~30% to ~85%)",
      "Better interest rates and commercial terms",
    ...
    faqs: [
      ...
      { q: "Do you guarantee loan approval after pre-underwriting?", a: "While we significantly improve approval chances, no one can guarantee approval as the final decision rests with the lender. However, our pre-underwritten applications have an ~85% approval rate vs ~30% for direct applications." },
    ...
    stats: [
      { label: "Approval Rate", value: "85", suffix: "%" },
      { label: "vs Direct Apply", value: "30", suffix: "%" },
  ...
  },
  {
    ...
    whatWeDo: [
      ...
      "Compare offers and help you choose the best terms",
    ],
    benefits: [
    ...
    processSteps: [
      { title: "Requirement Analysis", desc: "Understand your specific funding need — amount, purpose, timeline, and business context" },
      ...
      { title: "Multi-Lender Presentation", desc: "Present your case to multiple lenders simultaneously with a single CIBIL enquiry" },
      { title: "Offer Comparison", desc: "Compare offers from multiple lenders and identify the best terms for you" },
      { title: "Sanction & Disbursal", desc: "Manage follow-ups until sanction and ensure timely disbursal of funds" },
    ],
    faqs: [
      ...
      { q: "Will multiple lenders mean multiple CIBIL enquiries?", a: "No. We structure your application once and present it to multiple lenders. Only one CIBIL enquiry is triggered, protecting your credit score." },
      { q: "How long does the fund-raising process take?", a: "Unsecured loans: 7–14 days. Secured loans: 15–30 days. Complex cases: 30–45 days. We provide realistic timelines based on your specific situation." },
      { q: "What types of lenders are in your network?", a: "Our network includes PSU banks (SBI, PNB, Bank of Baroda), private banks (HDFC, ICICI, Axis), NBFCs (Bajaj, Tata Capital, Mahindra), and specialized lenders for specific sectors." },
    ...
    stats: [
      ...
      { label: "CIBIL Enquiries", value: "1", suffix: " only" },
      { label: "Avg Disbursal", value: "14", suffix: " days" },
  ...
  },
  {
    ...
    faqs: [
      { q: "What happens after my loan is disbursed?", a: "We set up a comprehensive tracking system for your loan — EMI calendar, outstanding monitoring, CIBIL tracking, and lender coordination. We stay engaged throughout the loan lifecycle." },
      ...
      { q: "How do you help with CIBIL management?", a: "We monitor your CIBIL report regularly, ensure all payments are accurately reflected, verify that closed loans show as closed, and coordinate corrections for any discrepancies with bureaus and lenders." },
    ...
    stats: [
      ...
      { label: "On-Time Payments", value: "99", suffix: "%" },
