  ...
  return (
    <div className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#1C1D62] text-center mb-4">Our Process</h2>
        <p className="text-[#718096] text-center mb-12 sm:mb-16 max-w-2xl mx-auto">From Assessment to Disbursal — a structured, disciplined approach.</p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            <motion.div
              key={step.id}
              className="relative p-6 rounded-3xl border border-[#E8ECF0] bg-white shadow-sm hover:shadow-2xl transition-all duration-300 hover:border-[#304AC0] group"
