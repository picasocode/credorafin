    ...
    <div className="relative w-32 h-32 sm:w-40 sm:h-40 mx-auto">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center">
          <div className="text-base sm:text-lg font-bold text-[#1C1D62]">EMI</div>
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <span className="inline-flex items-center gap-2 bg-[#304AC0]/10 text-[#304AC0] text-xs font-semibold uppercase tracking-widest px-3 sm:px-4 py-2 rounded-full mb-4">
            <Calculator className="w-3.5 h-3.5" />
            EMI Calculator
          </span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-[#1C1D62] leading-tight">
            Calculate Your EMI
          </h2>
          <p className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg text-[#718096] leading-relaxed">
        ...
        >
          <div className="grid lg:grid-cols-5 gap-0">
                ...
                <div className="flex justify-between items-center mb-2 gap-2">
                  ...
                  <div className="bg-white/10 rounded-lg px-3 py-1.5">
                    <Input
                      ...
                      className="bg-transparent border-0 text-right text-white font-semibold text-sm p-0 h-auto focus:ring-0 focus:outline-none w-28 sm:w-32 min-w-0"
                    />
                  </div>
                </div>
                <Slider
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="bg-white/10 rounded-lg px-3 py-1.5">
                    <Input
                      ...
                      className="bg-transparent border-0 text-right text-white font-semibold text-sm p-0 h-auto focus:ring-0 focus:outline-none w-32 sm:w-36 [color-scheme:dark]"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-3 p-4 sm:p-6 lg:p-8">
              ...
              {schedule.length > 0 && (
                <div className="bg-[#F7F9FC] rounded-xl p-4 mb-4 sm:mb-6">
...
function YearlyChart({ schedule }: { schedule: AmortizationRow[] }) {
  ...
  return (
    <div className="space-y-4 max-h-80 overflow-y-auto pr-2">
      {yearlyData.map((data) => (
        <div key={data.year} className="flex items-center gap-2 sm:gap-3">
          <span className="text-xs text-[#718096] w-10 sm:w-12 text-right flex-shrink-0">
            Yr {data.year}
          </span>
          <div className="flex-1 flex h-5 rounded-full overflow-hidden bg-[#E8ECF0] min-w-0">
            <motion.div
          ...
          <span className="text-xs text-[#718096] w-20 sm:w-24 flex-shrink-0 text-right">
